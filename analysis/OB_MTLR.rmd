...
hist(auc.mat$MTLR - auc.mat$MTLR.homosk,
     xlim = range(0, auc.mat$MTLR - auc.mat$MTLR.homosk),
     main = expression("MTLR on X,s vs MTLR on z"), cex.main = 2,
     xlab = expression(Delta[AUC]), cex.lab = 1.5)
...
hist(auc.mat$MTLR.homosk - auc.mat$ODP,
     xlim = range(0, auc.mat$MTLR.homosk - auc.mat$ODP),
     main = expression("MTLR on z vs ODP"), cex.main = 2,
     xlab = expression(Delta[AUC]), cex.lab = 1.5)
